...
<table class="table table-responsive table-striped table-bordered">
    ...
    @foreach($exam->questions as $id => $examQuestion)
        <tr>
            ...
            <td>
                <a class="btn btn-small btn-info" href="{{ URL::route('admin.exams.questions.show', $examQuestion->id) }}">Show</a>
                <a class="btn btn-small btn-warning" href="{{ URL::route('admin.exams.questions.edit', $examQuestion->id)}}">Edit</a>
                ...
                <a class="btn btn-small btn-danger" href="{{ URL::route('admin.exams.questions.destroy', $examQuestion->id) }}" data-method="delete" data-confirm="Are you sure?">Delete</a>
            </td>
        </tr>
    @endforeach
    </tbody>
